...
<div class="container py-5">
    ...
    <div class="card shadow-sm mb-4">
        <div class="card-header bg-primary text-white">
            <h5 class="mb-0">Structure du Répertoire Racine de Laravel</h5>
        </div>
        <div class="card-body">
            ...
            <table class="table table-striped table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>Fichiers de configuration de votre projet (.config).</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>Contient les fichiers publics comme JavaScript, CSS et les images de votre projet.</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>Fichiers de définition de routage (console.php, api.php, channels.php).</td>
                    </tr>
                    <tr>
